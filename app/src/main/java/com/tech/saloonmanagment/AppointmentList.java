...
public class AppointmentList extends AppCompatActivity {
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot studentDatasnap : dataSnapshot.getChildren()) {
                    ...
                    AppointmentDeatils appointmentDetails = studentDatasnap.getValue(AppointmentDeatils.class);
                    user.add(appointmentDetails);

                }

                MyAdapter adapter = new MyAdapter(AppointmentList.this, R.layout.custom_appointments_details, (ArrayList<AppointmentDeatils>) user);
    ...
    class MyAdapter extends ArrayAdapter<AppointmentDeatils> {
        LayoutInflater inflater;
        Context myContext;
        List<AppointmentDeatils> user;


        public MyAdapter(Context context, int resource, ArrayList<AppointmentDeatils> objects) {
        ...
        public View getView(int position, View view, ViewGroup parent) {
            ...
            holder.COL2.setText(user.get(position).getBarberName());
                ...
                public void onClick(View v) {
                    ...
                    reference.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            String name = (String) snapshot.child("barberName").getValue();
