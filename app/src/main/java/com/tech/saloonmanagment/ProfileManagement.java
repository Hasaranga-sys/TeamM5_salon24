...
public class ProfileManagement extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button = (Button) findViewById(R.id.updatabtn);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(ProfileManagement.this);

                View view1 = LayoutInflater.from(ProfileManagement.this).inflate(R.layout.update_profile,null);
                ...
                textView2.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Toast.makeText(ProfileManagement.this, "You Can't update your Email", Toast.LENGTH_SHORT).show();
                    }
                });
                ...
                textViewp.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Toast.makeText(ProfileManagement.this, "You Can't update your Password", Toast.LENGTH_SHORT).show();
                    }
                });
                ...
                button.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if(Name.isEmpty()) {
                            ...
                            Toast.makeText(ProfileManagement.this, "Profile Updated Successfully", Toast.LENGTH_SHORT).show();
